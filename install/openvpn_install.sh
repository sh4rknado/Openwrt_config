...
EOF2
	...
	cp -avr /etc/openvpn/ssl/ca.crt /etc/openvpn/ssl/my-client.* ${CERT_PATH}
...
mv client.ovpn ${CERT_PATH}

# ------------------- < SECTION OF network on the OpenWrt router > -------------------------
